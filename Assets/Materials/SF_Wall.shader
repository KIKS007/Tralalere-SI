...
////// Emissive:
                ...
                float3 emissive = lerp(lerp(_Wall_Color_down.rgb,lerp(_Wall_Color_middle.rgb,_Wall_Color_up.rgb,saturate(((i.uv0.g+_Wall_Color_up_position)*_Wall_Color_up_Falloff))),saturate(((i.uv0.g+_Wall_Color_down_position)*_Wall_Color_down_Falloff))),((abs(sin(node_4399.a))*0.5+0.5)*_Warning_color.rgb),((1.0 - saturate(frac(((_Warning_Speed*node_3010.g)-(_Warning__circles*sqrt((exp2(node_288)-exp2((i.normalDir*partZ).r))))))))*(1.0 - saturate(pow((node_288/_Warning_transition_distance),_Warning_Falloff)))));
                float3 finalColor = emissive;
                float4 node_9779 = _Time + _TimeEditor;
                float node_9329 = (i.uv0+(node_9779.r*_speed)*float2(0,1)).g;
                float4 node_4068 = _Time + _TimeEditor;
                return fixed4(finalColor,((1.0 - (sin((1200.0*node_9329))*0.5))*(((1.0 - (sin((node_9329*_Wall_largeur_trait))*0.5))*((1.0 - i.uv0.g.r)-_Wall_height))*(sin(node_4068.b)*0.2+1.0))));
            }
            ENDCG
        }
    }
