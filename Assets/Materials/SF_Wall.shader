...
////// Emissive:
                ...
                return fixed4(finalColor,((1.0 - (sin((1200.0*node_9329))*0.5))*(((1.0 - (sin((node_9329*_Wall_largeur_trait))*0.5))*((1.0 - __World_Y.r)-_Wall_height))*(sin(node_4068.b)*0.2+1.0))));
            }
            ENDCG
        }
    }
