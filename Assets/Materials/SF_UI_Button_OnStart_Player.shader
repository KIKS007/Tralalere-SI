...
Shader "Shader Forge/SF_UI_OnStartScroll" {
    Properties {
        ...
        _Contour_Color_OnStart ("Contour_Color_OnStart", Color) = (0.4044118,0.8521298,1,1)
...
////// Emissive:
                ...
                float3 emissive = lerp(_Fond_Color.rgb,_Contour_Color_OnStart.rgb,saturate((_Contour_paisseur*(pow(abs(node_5601.r),node_4872)+pow(abs(node_5601.g),node_4872)))));
