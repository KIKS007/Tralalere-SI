...
Shader "Shader Forge/SF_UI_OnStartScroll" {
    Properties {
        ...
        _Contour_Color_OnStart ("Contour_Color_OnStart", Color) = (0.942495,1,0.4044118,1)
        _node_8848 ("node_8848", Range(1, 3)) = 1
...
////// Emissive:
                ...
                float3 emissive = lerp(_Fond_Color.rgb,lerp(lerp(_Contour_Color_Inventory.rgb,_Contour_Color_PLayer.rgb,(_node_8848*1.0+-1.0)),_Contour_Color_OnStart.rgb,(_node_8848*1.0+-2.0)),saturate((pow(abs(node_5601.r),node_4872)+pow(abs(node_5601.g),node_4872))));
