...
Shader "Shader Forge/SF_UI_OnStartScroll" {
    Properties {
        ...
        _Contour_Color_OnStart ("Contour_Color_OnStart", Color) = (0.4044118,1,0.4085193,1)
...
////// Emissive:
                ...
                float node_5520 = abs(node_5601.r);
                float4 node_2632 = _Time + _TimeEditor;
                float node_4872 = (sin((node_2632.g*_Contour_vitesse_variation))*5.0+15.0);
                float node_1693 = abs(node_5601.g);
                float node_5874 = (pow(node_5520,node_4872)+pow(node_1693,node_4872));
                float3 emissive = lerp(_Fond_Color.rgb,_Contour_Color_OnStart.rgb,saturate((_Contour_paisseur*node_5874)));
