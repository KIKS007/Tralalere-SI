...
Shader "Shader Forge/SF_UI_OnStartScroll" {
    Properties {
        ...
        _Opacity ("Opacity", Range(0, 1)) = 0.8388197
...
////// Emissive:
                ...
                float3 emissive = lerp(_Grille_Color.rgb,_Grille_Color_variation.rgb,(saturate((pow(((1.0 - (saturate(node_8964)*node_6799))*node_6799),_Balayage_taille)*_Balayage_opacit))+node_4976));
                float3 finalColor = emissive;
                float node_5637 = (_Opacity+node_4976);
                return fixed4(finalColor,node_5637);
            }
            ENDCG
        }
    }
